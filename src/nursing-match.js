...
// 기준이라 실제 장소 정문까지 도보 3~5분(300~400m대) 정도 차이가 나는 경우가
// 흔해서(예: 전쟁기념관↔삼각지역 312m) 400m로 잡았다 — 그 이상(700m+)은 오탐
// 위험이 커져서 실측 후 제외함. 그래도 확신할 수 없는 매칭이라 확인상태는 항상
// "공공데이터"(대기)로만 남기고, 사람이 검토해서 "확인됨"으로 바꿔야 최종
// 확정된다.
const EARTH_RADIUS_M = 6371000;
const DEFAULT_MAX_DISTANCE_M = 400;
