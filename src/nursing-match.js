...
// 기준이라 실제 장소 정문까지 도보 1~2분(100~200m대) 정도 차이가 나는 경우가
// 흔해서(예: 서대문형무소역사관↔독립문역 150.8m) 250m로 잡았다 — 그래도 확신할
// 수 없는 매칭이라 확인상태는 항상 "공공데이터"(대기)로만 남기고, 사람이
// 검토해서 "확인됨"으로 바꿔야 최종 확정된다.
